 ...
 */
final class Version20241223172958 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_gamer (group_id INT NOT NULL, gamer_id INT NOT NULL, INDEX IDX_D80830C02F43A116 (gamer_id), INDEX IDX_D80830C0FE54D947 (group_id), PRIMARY KEY(group_id, gamer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
