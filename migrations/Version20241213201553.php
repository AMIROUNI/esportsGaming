 ...
 */
final class Version20241213201553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, image LONGBLOB DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE group_gamer (group_id INT NOT NULL, gamer_id INT NOT NULL, INDEX IDX_D80830C0FE54D947 (group_id), INDEX IDX_D80830C02F43A116 (gamer_id), PRIMARY KEY(group_id, gamer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
